...
figure('Name', 'Duty Cycle vs Frequency and No Load Condition', 'NumberTitle', 'off');
hold on; 
grid on;
...
for idx = 1:length(frequencies)
    i = idx + 1;
    current = semilab2{i}{1}.Values.Data*-1;
...
title('Duty Cycle vs Frequency and Current No Load Condition', 'FontSize', 14, 'FontWeight', 'bold');
...
sgtitle('Duty Cycle vs Frequency and Current No Load Condition', 'FontSize', 14, 'FontWeight', 'bold');  % Super title for the whole figure
